    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between text-[10px] text-zinc-500">
            <span>Chroma</span>
            <span>{state.chroma.toFixed(2)}</span>
          </div>
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between text-[10px] text-zinc-500">
            <span>Lightness</span>
            <span>{Math.round(state.lightness)}%</span>
          </div>
          <div className="relative h-4 rounded-full overflow-hidden">
            <div 
      ...
      {onRandomize && (
        <button
          onClick={onRandomize}
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium hover:from-indigo-600 hover:to-purple-600 transition-all shadow-lg active:scale-95"
        >
